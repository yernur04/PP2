...
namespace Lab_1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] ars = s.Split(' '); // we divide each array number as an array of strings
            int[] arr2 = new int[2 * n];  //  we declare the second array with two more elements
            int[] arr1 = new int[n];  // declare the first array
            for (int i = 0; i < ars.Length; i++)  // all elements of the array of strings are converted into elements of an array of integers 
            {
